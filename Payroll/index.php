			  ...
			  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
			    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
			      <li class="nav-item active">
			        <a class="nav-link" href="https://github.com/BUGHUNTER18">Git <span class="sr-only">(current)</span></a>
			      </li>
			      <li class="nav-item">
		    ...
		    <footer>
		        <div class="row">
		            <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
		                <p><u><a href="https://github.com/BUGHUNTER18" style="color:black;">Automated Payroll </a></u> is a Registered Website of IIT Dh, Inc. India 
		                <p class="h6">&copy All right Reversed.<a class="text-green ml-2" href="https://github.com/BUGHUNTER18" target="_blank" style="color:black;">Team 5</a></p>
		            </div>
		            </hr>
		        </div>  
		    </footer>
